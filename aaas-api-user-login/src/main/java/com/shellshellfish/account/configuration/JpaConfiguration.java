package com.shellshellfish.account.configuration;
...
public class JpaConfiguration {
	...
	/*
	 * Populate SpringBoot DataSourceProperties object directly from application-prod.yml
	...
	public LocalContainerEntityManagerFactoryBean entityManagerFactory() throws NamingException {
		...
		factoryBean.setPackagesToScan(new String[] { "com.shellshellfish.account.model" });
