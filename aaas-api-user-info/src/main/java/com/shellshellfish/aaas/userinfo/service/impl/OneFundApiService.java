...
public class OneFundApiService implements FundTradeApiService {
	...
	@Override
	public OpenAccountResult openAccount(String userUuid, String name, String phone,
			String identityNo, String bankNo, String bankId) throws Exception {
...
//        info.put("bank_id", "005");
	...
	@Override
	public BuyFundResult buyFund(String userUuid, String tradeAcco, BigDecimal applySum,
			String outsideOrderNo, String fundCode) throws Exception {
	...
	@Override
	public SellFundResult sellFund(String userUuid, Integer sellNum, String outsideOrderNo,
			String tradeAcco, String fundCode) throws Exception {
		fundCode = trimSuffix(fundCode);
	...
	@Override
	public ApplyResult getApplyResultByApplySerial(String userUuid, String applySerial)
	...
	@Override
	public ApplyResult getApplyResultByOutsideOrderNo(String userUuid, String outsideOrderNo)
			throws JsonProcessingException {
		Map<String, Object> info = init(userUuid);
		info.put("outsideorderno", outsideOrderNo);
		postInit(info);
	...
	private ApplyResult getApplyResult(ApplyResult applyResult, JSONObject jsonObject,
			Integer status) {
		if (status.equals(1)) {
	...
	@Override
	public ConfirmResult getConfirmResultByApplySerial(String userUuid, String applySerial)
			throws JsonProcessingException {
		Map<String, Object> info = init(userUuid);
		info.put("applyserial", applySerial);
		postInit(info);
	...
	@Override
	public ConfirmResult getConfirmResultByOutsideOrderNo(String userUuid, String outsideOrderNo)
			throws JsonProcessingException {
		Map<String, Object> info = init(userUuid);
		info.put("outsideorderno", outsideOrderNo);
		postInit(info);
	...
	private ConfirmResult getConfirmResult(ConfirmResult confirmResult, JSONObject jsonObject,
			Integer status) {
		if (status.equals(1)) {
			JSONArray jsonArray = jsonObject.getJSONArray("data");
	...
	@Override
	public List<ConfirmResult> getConfirmResults(String userUuid, String fundCode, String confirmDate)
			throws JsonProcessingException {
		String json = getAllConfirmList(userUuid, fundCode, confirmDate);
	...
	@Override
	public String getAllConfirmList(String userUuid, String fundCode, String confirmDate)
			throws JsonProcessingException {
		fundCode = trimSuffix(fundCode);
		Map<String, Object> info = init(userUuid);
...
//        fakeAnswer.put("00032", "004");
	...
	@Override
	public List<TradeRateResult> getTradeRateAsList(String fundCode, String businFlag)
			throws JsonProcessingException {
		fundCode = trimSuffix(fundCode);
	...
	public BigDecimal getRate(String fundCode, String businFlag) throws Exception {
		...
		for (TradeRateResult rateResult : tradeRateResults) {
			if (rateResult.getChngMinTermMark().equals("日常申购费") && rateResult.getChagRateUnitMark()
					.equals("%")) {
	...
	@Override
	public BigDecimal calcPoundageByTotalAmount(BigDecimal totalAmount, BigDecimal rate,
			BigDecimal discount) {
	...
	@Override
	public List<BonusInfo> getBonusList(String userUuid, String fundCode, String startDate)
			throws Exception {
		fundCode = trimSuffix(fundCode);
		...
		String url = "https://onetest.51fa.la/v2/internet/fundapi/get_bonus_list";
	...
	public FundShare getFundShare(String userUuid, String fundCode) throws Exception {
		...
		String url = "https://onetest.51fa.la/v2/internet/fundapi/get_fund_share";
	...
	public FundIncome getFundIncome(String userUuid, String fundCode) throws Exception {
		...
		String url = "https://onetest.51fa.la/v2/internet/fundapi/get_incomes";
	 ...
	 */
	@Override
	public List<FundNet> getFundNets(String fundCode, Integer startIndex, Integer count)
			throws JsonProcessingException {
		fundCode = trimSuffix(fundCode);
		...
		List<FundNet> fundNets = new ArrayList<>(jsonArray.size());
		for (int i = 0; i < jsonArray.size(); i++) {
			FundNet fundNet = jsonArray.getObject(i, FundNet.class);
			if (fundNet != null) {
				fundNets.add(fundNet);
			}
	...
	public Map<String, BankCardLimitation> getBankCardLimitations() {
		if (bankCardLimitations.isEmpty()) {
			bankCardLimitations.put("中国银行",
					new BankCardLimitation(BigDecimal.valueOf(50000), BigDecimal.valueOf(500000)));
			bankCardLimitations.put("农业银行",
					new BankCardLimitation(BigDecimal.valueOf(20000), BigDecimal.valueOf(20000)));
			bankCardLimitations.put("建设银行",
					new BankCardLimitation(BigDecimal.valueOf(50000), BigDecimal.valueOf(50000)));
			bankCardLimitations.put("中国银行",
					new BankCardLimitation(BigDecimal.valueOf(50000), BigDecimal.valueOf(50000)));
			bankCardLimitations
					.put("中信银行", new BankCardLimitation(BigDecimal.valueOf(5000), BigDecimal.valueOf(5000)));
			bankCardLimitations.put("广发银行",
					new BankCardLimitation(BigDecimal.valueOf(500000), BigDecimal.valueOf(Long.MAX_VALUE)));
			// bankCardLimitations.put("民生银行", new BankCardLimitation(BigDecimal.valueOf(50000), BigDecimal.valueOf(500000)));
			bankCardLimitations.put("平安银行",
					new BankCardLimitation(BigDecimal.valueOf(500000), BigDecimal.valueOf(5000000)));
			bankCardLimitations.put("光大银行",
					new BankCardLimitation(BigDecimal.valueOf(50000), BigDecimal.valueOf(50000)));
			bankCardLimitations.put("浦发银行",
					new BankCardLimitation(BigDecimal.valueOf(50000), BigDecimal.valueOf(50000)));
			bankCardLimitations.put("交通银行",
					new BankCardLimitation(BigDecimal.valueOf(50000), BigDecimal.valueOf(50000)));
			bankCardLimitations.put("工商银行",
					new BankCardLimitation(BigDecimal.valueOf(50000), BigDecimal.valueOf(50000)));
			bankCardLimitations.put("邮储银行",
					new BankCardLimitation(BigDecimal.valueOf(50000), BigDecimal.valueOf(50000)));
			bankCardLimitations.put("兴业银行",
					new BankCardLimitation(BigDecimal.valueOf(50000), BigDecimal.valueOf(50000)));
		}
