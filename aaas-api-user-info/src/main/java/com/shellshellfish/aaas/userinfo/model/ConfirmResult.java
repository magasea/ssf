...
public class ConfirmResult {
	...
	public void setOppfundcode(String oppfundcode) {
		this.oppfundcode = oppfundcode;
	}
	...
	public void setOppsaler(String oppsaler) {
		this.oppsaler = oppsaler;
	}

	public String getOpptrusteebranch() {
		return opptrusteebranch;
	}

	public void setOpptrusteebranch(String opptrusteebranch) {
		this.opptrusteebranch = opptrusteebranch;
	}
	...
	public void setMintredeem(String mintredeem) {
		this.mintredeem = mintredeem;
	}

	public String getCommisiondiscount() {
		return commisiondiscount;
	}

	public void setCommisiondiscount(String commisiondiscount) {
		this.commisiondiscount = commisiondiscount;
	}
	...
	public String getOriginalapplyserial() {
		return originalapplyserial;
	}

	public void setOriginalapplyserial(String originalapplyserial) {
		this.originalapplyserial = originalapplyserial;
	}
	...
	public void setTradeconfirmshare(String tradeconfirmshare) {
	...
	public void setTradeconfirmsum(String tradeconfirmsum) {
	...
	public String toString() {
		return "ConfirmResult{" +
				...
				", oppfundcode='" + oppfundcode + '\'' +
				", oppsaler='" + oppsaler + '\'' +
				", opptrusteebranch='" + opptrusteebranch + '\'' +
				", mintredeem='" + mintredeem + '\'' +
				", commisiondiscount='" + commisiondiscount + '\'' +
				", melonmethod='" + melonmethod + '\'' +
				", freezemethod='" + freezemethod + '\'' +
				", originalapplyserial='" + originalapplyserial + '\'' +
