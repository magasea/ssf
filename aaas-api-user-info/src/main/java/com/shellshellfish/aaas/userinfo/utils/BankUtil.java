...
//  }
	 ...
	 * @return true
	 */
	public static boolean Luhn(String bankcode){
		boolean status = false;
		char res = getBankCardCheckCode(bankcode.substring(0, bankcode.length()-1));
		if(res!='N'){
			String charJX = bankcode.substring(bankcode.length()-1);//获得银行卡校验位
