...
@EnableMongoRepositories(basePackages = {
		"com.shellshellfish.aaas.userinfo.repositories.funds"}, mongoTemplateRef = "fundsMongoTemplate")
public class FundsMongoConfiguration {
	...
	@Value("${spring.data.mongodb.funds}")
	private String fundsDatabase;

	@Bean(name = "fundsMongoTemplate")
	@PostConstruct
	public MongoTemplate mongoTemplate() {
		MongoTemplate mongoTemplate = new MongoTemplate(new MongoClient(host, port), fundsDatabase);
