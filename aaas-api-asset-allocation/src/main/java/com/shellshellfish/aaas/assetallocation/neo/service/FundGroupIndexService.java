...
@Service
public class FundGroupIndexService {
     ...
     */
    public void calculateAnnualVolatilityAndAnnualYeild(String groupId, String subGroupId, LocalDate startDate) {
        if (startDate == null) {
        ...
        do {
            values.add(fundGroupHistoryMapper.getLatestNavAdj(groupId, subGroupId, date));
        ...
        logger.info(" calculate historical annual yeild and Historical annual volatility   groupId:{} ,subGroupId{}", groupId, subGroupId);
    }
