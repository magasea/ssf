...
import com.shellshellfish.aaas.common.utils.*;
...
//		List<FundYeildRate> fundYeildRateList = getLastFundYeildRates4Test(codes);
    ...
    private void copyProperites(List<CoinFundYieldRate> originList, GrowthRateOfMonetaryFundCollection.Builder builder) {
        ...
        for (int i = 0; i < originList.size(); i++) {
            ...
            growthRateOfMonetaryFundsBuilder.setTenKiloUnitYield(Optional.ofNullable(coinFundYieldRate
                    .getTenKiloUnitYield()).orElse(0D));
            growthRateOfMonetaryFundsBuilder.setYieldof7Days(Optional.ofNullable(coinFundYieldRate.getYieldoOf7Days())
                    .orElse(0D));
