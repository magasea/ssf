...
//  }
	...
	public static String getZZBankNameFromOriginBankName(String originBankName){
  ...
  private final static String[] bankBin = {
      ...
      "623251", "628351", "622568", "520152", "520382", "911121", "548844" };
  ...
  private static final String[] bankName = {
      ...
      "中国银行曼谷分行·长城信用卡环球通", "中国银行曼谷分行·借记卡", "中国建设银行·龙卡准贷记卡", "中国建设银行·龙卡准贷记卡金卡", "中国建设银行·中职学生资助卡", "中国建设银行·乐当家银卡VISA", "中国建设银行·乐当家金卡VISA",
      "中国建设银行·乐当家白金卡", "中国建设银行·龙卡普通卡VISA", "中国建设银行·龙卡储蓄卡", "中国建设银行·VISA准贷记卡(银联卡)", "中国建设银行·VISA准贷记金卡", "中国建设银行·乐当家", "中国建设银行·乐当家", "中国建设银行·准贷记金卡",
      "中国建设银行·乐当家白金卡", "中国建设银行·金融复合IC卡", "中国建设银行·银联标准卡", "中国建设银行·银联理财钻石卡", "中国建设银行·金融IC卡", "中国建设银行·理财白金卡", "中国建设银行·社保IC卡", "中国建设银行·财富卡私人银行卡",
      "中国建设银行·理财金卡", "中国建设银行·福农卡", "中国建设银行·武警军人保障卡", "中国建设银行·龙卡通", "中国建设银行·银联储蓄卡", "中国建设银行·龙卡储蓄卡(银联卡)", "中国建设银行·准贷记卡", "中国建设银行·理财白金卡", "中国建设银行·理财金卡",
      "中国建设银行·准贷记卡普卡", "中国建设银行·准贷记卡金卡", "中国建设银行·龙卡信用卡", "中国建设银行·建行陆港通龙卡", "中国建设银行·普通高中学生资助卡", "中国建设银行·中国旅游卡", "中国建设银行·龙卡JCB金卡",
      ...
      "重庆农村商业银行·银联标准贷记卡", "重庆农村商业银行·公务卡", "南阳村镇银行·玉都卡", "晋中市榆次融信村镇银行·魏榆卡", "三水珠江村镇银行·珠江太阳卡", "东营莱商村镇银行·绿洲卡", "中国建设银行·单位结算卡",
      "玉溪市商业银行·红塔卡","广东发展银行新理财通借记卡","广东发展银行南航明珠卡MC金卡","广东发展银行南航明珠卡MC普卡","广东发展银行理财通借记卡","广发真情卡" };
  
  
  //传入卡号 得到银行CODE
  public static String getCodeOfBank(String idCard) {
    int index = -1;
...
//"发卡行.卡种名称",
  private static final String[] bankCode = {
	      "PSBC", "PSBC", "PSBC", "PSBC", "PSBC",
	      "PSBC", "PSBC", "PSBC", "PSBC", "PSBC",
	      "PSBC", "PSBC", "PSBC", "PSBC", "PSBC",
	      "PSBC", "PSBC", "PSBC", "PSBC",
	      "PSBC", "ICBC", "ICBC", "ICBC", "ICBC",
	      "ICBC", "ICBC", "ICBC", "ICBC", "ICBC",
	      "ICBC", "ICBC", "ICBC", "ICBC", "ICBC",
	      "ICBC", "ICBC", "ICBC", "ICBC", "ICBC",
	      "ICBC", "ICBC", "ICBC", "ICBC", "ICBC",
	      "ICBC", "ICBC", "ICBC", "ICBC", "ICBC",
	      "ICBC", "ICBC", "ICBC", "ICBC", "ICBC", "ICBC",
	      "ICBC", "ICBC", "ICBC", "ICBC", "ICBC", "ICBC",
	      "ICBC", "ICBC", "ICBC", "ICBC", "ICBC", "ICBC",
	      "ICBC", "ICBC", "ICBC", "ICBC", "ICBC", "ICBC",
	      "ICBC", "ICBC", "ICBC", "ICBC", "ICBC", "ICBC",
	      ...
	      "ABC", "ABC", "ABC", "ABC", "ABC", "ABC",
	      "ABC", "ABC", "ABC", "ABC", "ABC", "ABC",
	      "ABC", "ABC", "NBNYBC", "BOC", "BOC", "BOC", "BOC",
	      ...
	      "BOC", "BOC", "BOC", "BOC", "BOC",
	      "BOC", "BOC", "BOC", "BOC", "BOC", "BOC",
	      "BOC", "BOC", "CCB", "CCB", "CCB", "CCB", "CCB",
	      "CCB", "CCB", "CCB", "CCB", "CCB", "CCB", "CCB", "CCB",
	      "CCB", "CCB", "CCB", "CCB", "CCB", "CCB", "CCB", "CCB",
	      "CCB", "CCB", "CCB", "CCB", "CCB", "CCB", "CCB", "CCB", "CCB",
	      "CCB", "CCB", "CCB", "CCB", "CCB", "CCB", "CCB",
	      "CCB", "CCB", "CCB", "CCB", "CCB", "CCB",
	      "CCB", "CCB", "CCB", "CCB", "CCB", "CCB",
	      "CCB", "CCB", "CCB", "CCB", "CCB", "CCB",
	      "CCB", "CCB", "CCB", "CCB", "CCB", "CCB",
	      "CCB", "CCB", "CCB", "MCM", "MCM", "MCM", "MCM",
	      "MCM", "MCM", "MCM", "MCM", "MCM", "MCM",
	      "MCM", "MCM", "MCM", "MCM", "MCM", "MCM", "MCM",
	      "MCM", "MCM", "MCM", "MCM", "MCM", "MCM", "MCM", "MCM",
	      "MCM", "MCM", "MCM", "MCM", "MCM", "MCM", "MCM",
	      "MCM", "MCM", "MCM", "MCM", "MCM", "MCM",
	      "MCM", "MCM", "MCM", "MCM", "MCM", "CITIC", "CITIC",
	      "CITIC", "CITIC", "CITIC", "CITIC", "CITIC", "CITIC", "CITIC",
	      "CITIC", "CITIC", "CITIC", "CITIC", "CITIC", "CITIC", "CITIC",
	      "CITIC", "CITIC", "CITIC", "CITIC", "CITIC", "CITIC", "CITIC", "CEB",
	      "CEB", "CEB", "CEB", "CEB", "CEB", "CEB", "CEB",
	      "CEB", "CEB", "CEB", "CEB", "CEB", "CEB", "CEB",
	      "CEB", "CEB", "CEB", "CEB", "CEB", "CEB", "CEB", "CEB",
	      "CEB", "CEB", "CEB", "CEB", "CEB", "CEB", "CEB", "HXB",
	      "HXB", "HXB", "HXB", "HXB", "HXB", "HXB", "HXB", "HXB",
	      "HXB", "CMBC", "CMBC", "CMBC", "CMBC", "CMBC", "CMBC",
	      "CMBC", "CMBC", "CMBC", "CMBC", "CMBC", "CMBC", "CMBC", "CMBC",
	      "CMBC", "CMBC", "CMBC", "CMBC", "CMBC", "CMBC", "CMBC", "CMBC",
	      "CMBC", "CMBC", "CMBC", "CMBC", "CMBC", "CMBC", "CMBC",
	      "CMBC", "CMBC", "CMBC", "CMBC", "CMBC", "CMBC", "CMBC",
	      "CMBC", "CMBC", "CMBC", "CMBC", "CMBC", "CMBC", "CMBC",
	      "CMBC", "CMBC", "CMBC", "CMBC", "CMBC", "CMBC",
	      "CMBC", "CMBC", "CMB", "CMB", "CMB", "CMB", "CMB", "CMB",
	      "CMB", "CMB", "CMB", "CMB", "CMB", "CMB", "CMB",
	      ...
	      "CMB", "CMB", "CMB", "CMB", "CMB",
	      "CMB", "CMB", "CMB", "CMB", "CMB",
	      "CMB", "CIB", "CIB", "CIB", "CIB", "CIB",
	      "CIB", "CIB", "CIB", "CIB", "CIB", "CIB",
	      "CIB", "CIB", "CIB", "CIB", "CIB", "CIB", "CIB",
	      "CIB", "CIB", "CIB", "CIB", "CIB", "CIB", "CIB",
	      "CIB", "CIB", "CIB", "CIB", "CIB", "CIB", "CIB", "SPDB",
	      "SPDB", "SPDB", "SPDB", "SPDB", "SPDB", "SPDB", "SPDB",
	      "SPDB", "SPDB", "SPDB", "SPDB", "SPDB", "SPDB", "SPDB",
	      "SPDB", "SPDB", "SPDB", "SPDB", "SPDB", "SPDB", "SPDB",
	      "SPDB", "SPDB", "SPDB", "SPDB", "SPDB", "SPDB", "SPDB",
	      "SPDB", "SPDB", "SPDB", "SPDB", "SPDB", "SPDB",
	      "SPDB", "SPDB", "SPDB", "SPDB", "SPDB", "恒丰银行·九州IC卡",
	      "恒丰银行·九州借记卡(银联卡)", "恒丰银行·九州借记卡(银联卡)", "天津市商业银行·银联卡(银联卡)", "烟台商业银行·金通卡", "潍坊银行·鸢都卡(银联卡)", "潍坊银行·鸳都卡(银联卡)", "临沂商业银行·沂蒙卡(银联卡)",
	      "临沂商业银行·沂蒙卡(银联卡)", "日照市商业银行·黄海卡", "日照市商业银行·黄海卡(银联卡)", "浙商银行·商卡", "浙商银行·商卡", "渤海银行·浩瀚金卡", "渤海银行·渤海银行借记卡", "渤海银行·金融IC卡",
	      "渤海银行·渤海银行公司借记卡", "星展银行·星展银行借记卡", "星展银行·星展银行借记卡", "恒生银行·恒生通财卡", "恒生银行·恒生优越通财卡", "新韩银行·新韩卡", "上海银行·慧通钻石卡", "上海银行·慧通金卡",
	      "上海银行·私人银行卡", "上海银行·综合保险卡", "上海银行·申卡社保副卡(有折)", "上海银行·申卡社保副卡(无折)", "上海银行·白金IC借记卡", "上海银行·慧通白金卡(配折)", "上海银行·慧通白金卡(不配折)",
	      ...
	      "吉林银行·君子兰卡(银联卡)", "吉林银行·长白山金融IC卡", "吉林银行·信用卡", "吉林银行·信用卡", "吉林银行·公务卡", "镇江市商业银行·金山灵通卡(银联卡)", "镇江市商业银行·金山灵通卡(银联卡)",
	      "宁波银行·银联标准卡", "宁波银行·汇通借记卡", "宁波银行·汇通卡(银联卡)", "宁波银行·明州卡", "宁波银行·汇通借记卡", "宁波银行·汇通国际卡银联双币卡", "宁波银行·汇通国际卡银联双币卡",
	      "PAB", "PAB", "PAB", "PAB", "PAB", "PAB", "焦作市商业银行·月季借记卡(银联卡)",
	      "焦作市商业银行·月季城市通(银联卡)", "焦作市商业银行·中国旅游卡", "温州银行·金鹿卡", "汉口银行·九通卡(银联卡)", "汉口银行·九通卡", "汉口银行·借记卡", "汉口银行·借记卡", "盛京银行·玫瑰卡",
	      "盛京银行·玫瑰IC卡", "盛京银行·玫瑰IC卡", "盛京银行·玫瑰卡", "盛京银行·玫瑰卡", "盛京银行·玫瑰卡(银联卡)", "盛京银行·玫瑰卡(银联卡)", "盛京银行·盛京银行公务卡", "洛阳银行·都市一卡通(银联卡)",
	      "洛阳银行·都市一卡通(银联卡)", "洛阳银行·--", "大连银行·北方明珠卡", "大连银行·人民币借记卡", "大连银行·金融IC借记卡", "大连银行·大连市社会保障卡", "大连银行·借记IC卡", "大连银行·借记IC卡",
	      "大连银行·大连市商业银行贷记卡", "大连银行·大连市商业银行贷记卡", "大连银行·银联标准公务卡", "苏州市商业银行·姑苏卡", "杭州商业银行·西湖卡", "杭州商业银行·西湖卡", "杭州商业银行·借记IC卡",
	      ...
	      "徽商银行·徽商银行中国旅游卡（安徽）", "徽商银行合肥分行·黄山卡", "徽商银行芜湖分行·黄山卡(银联卡)", "徽商银行马鞍山分行·黄山卡(银联卡)", "徽商银行淮北分行·黄山卡(银联卡)", "徽商银行安庆分行·黄山卡(银联卡)",
	      "重庆银行·长江卡(银联卡)", "重庆银行·长江卡(银联卡)", "重庆银行·长江卡", "重庆银行·借记IC卡", "哈尔滨银行·丁香一卡通(银联卡)", "哈尔滨银行·丁香借记卡(银联卡)", "哈尔滨银行·丁香卡", "哈尔滨银行·福农借记卡",
	      "无锡市商业银行·太湖金保卡(银联卡)", "丹东银行·借记IC卡", "丹东银行·丹东银行公务卡", "LZCB", "南昌银行·金瑞卡(银联卡)", "南昌银行·南昌银行借记卡", "南昌银行·金瑞卡", "晋商银行·晋龙一卡通",
	      "晋商银行·晋龙一卡通", "晋商银行·晋龙卡(银联卡)", "青岛银行·金桥通卡", "青岛银行·金桥卡(银联卡)", "青岛银行·金桥卡(银联卡)", "青岛银行·金桥卡", "青岛银行·借记IC卡", "吉林银行·雾凇卡(银联卡)",
	      "吉林银行·雾凇卡(银联卡)", "南通商业银行·金桥卡(银联卡)", "南通商业银行·金桥卡(银联卡)", "日照银行·黄海卡、财富卡借记卡", "鞍山银行·千山卡(银联卡)", "鞍山银行·千山卡(银联卡)", "鞍山银行·千山卡",
	      "青海银行·三江银行卡(银联卡)", "青海银行·三江卡", "台州银行·大唐贷记卡", "台州银行·大唐准贷记卡", "台州银行·大唐卡(银联卡)", "台州银行·大唐卡", "台州银行·借记卡", "台州银行·公务卡",
	      "泉州银行·海峡银联卡(银联卡)", "泉州银行·海峡储蓄卡", "泉州银行·海峡银联卡(银联卡)", "泉州银行·海峡卡", "泉州银行·公务卡", "昆明商业银行·春城卡(银联卡)", "昆明商业银行·春城卡(银联卡)",
	      ...
	      "天津滨海农村商业银行·四海通e芯卡", "武汉农村商业银行·汉卡", "武汉农村商业银行·汉卡", "武汉农村商业银行·中国旅游卡", "江南农村商业银行·阳湖卡(银联卡)", "江南农村商业银行·天天红火卡",
	      "江南农村商业银行·借记IC卡", "海口联合农村商业银行·海口联合农村商业银行合卡", "湖北嘉鱼吴江村镇银行·垂虹卡", "福建建瓯石狮村镇银行·玉竹卡", "浙江平湖工银村镇银行·金平卡", "重庆璧山工银村镇银行·翡翠卡",
	      "重庆农村商业银行·银联标准贷记卡", "重庆农村商业银行·公务卡", "南阳村镇银行·玉都卡", "晋中市榆次融信村镇银行·魏榆卡", "三水珠江村镇银行·珠江太阳卡", "东营莱商村镇银行·绿洲卡", "CCB",
	      "玉溪市商业银行·红塔卡", "GDB","GDB","GDB","GDB","GDB" };
