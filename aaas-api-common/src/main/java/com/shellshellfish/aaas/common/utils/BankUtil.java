...
//"发卡行.卡种名称",
  private static final String[] bankCode = {
	      ...
	      "BC", "BC", "BC", "BC", "BC",
	      "BC", "BC", "BC", "BC", "BC", "BC",
	      "BC", "BC", "NBCBC", "NBCBC", "NBCBC", "NBCBC", "NBCBC",
	      "NBCBC", "NBCBC", "NBCBC", "NBCBC", "NBCBC", "NBCBC", "NBCBC", "NBCBC",
	      "NBCBC", "NBCBC", "NBCBC", "NBCBC", "NBCBC", "NBCBC", "NBCBC", "NBCBC",
	      "NBCBC", "NBCBC", "NBCBC", "NBCBC", "NBCBC", "NBCBC", "NBCBC", "NBCBC", "NBCBC",
	      "NBCBC", "NBCBC", "NBCBC", "NBCBC", "CCB", "CCB", "CCB",
	      ...
	      "天津滨海农村商业银行·四海通e芯卡", "武汉农村商业银行·汉卡", "武汉农村商业银行·汉卡", "武汉农村商业银行·中国旅游卡", "江南农村商业银行·阳湖卡(银联卡)", "江南农村商业银行·天天红火卡",
	      "江南农村商业银行·借记IC卡", "海口联合农村商业银行·海口联合农村商业银行合卡", "湖北嘉鱼吴江村镇银行·垂虹卡", "福建建瓯石狮村镇银行·玉竹卡", "浙江平湖工银村镇银行·金平卡", "重庆璧山工银村镇银行·翡翠卡",
	      "重庆农村商业银行·银联标准贷记卡", "重庆农村商业银行·公务卡", "南阳村镇银行·玉都卡", "晋中市榆次融信村镇银行·魏榆卡", "三水珠江村镇银行·珠江太阳卡", "东营莱商村镇银行·绿洲卡", "NBCBC",
	      "玉溪市商业银行·红塔卡", "广东发展银行新理财通借记卡","广东发展银行南航明珠卡MC金卡","广东发展银行南航明珠卡MC普卡","广东发展银行理财通借记卡","广发真情卡" };
