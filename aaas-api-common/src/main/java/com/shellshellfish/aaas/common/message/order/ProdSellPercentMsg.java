...
public class ProdSellPercentMsg implements Serializable{
  ...
  //精确到万分之一的整型
  private Long sellTargetPercent;
  ...
  public Long getSellTargetPercent() {
    return sellTargetPercent;
  }

  public void setSellTargetPercent(Long sellTargetMoney) {
    this.sellTargetPercent = sellTargetMoney;
  }
