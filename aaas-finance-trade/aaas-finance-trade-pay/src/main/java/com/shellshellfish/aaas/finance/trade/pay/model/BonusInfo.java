...
public class BonusInfo {
    ...
    public void setBonusshare(String bonusshare) {
    ...
    public String getBonustotalsum() {
        return bonustotalsum;
    }

    public void setBonustotalsum(String bonustotalsum) {
        this.bonustotalsum = bonustotalsum;
    }
    ...
    public void setMelonmethodStr(String melonmethodStr) {
        this.melonmethodStr = melonmethodStr;
    }
