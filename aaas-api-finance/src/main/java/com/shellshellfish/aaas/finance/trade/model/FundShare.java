...
public class FundShare {
    ...
    public void setExpireshares(String expireshares) {
        this.expireshares = expireshares;
    }
    ...
    public String getBankcustomname() {
        return bankcustomname;
    }

    public void setBankcustomname(String bankcustomname) {
        this.bankcustomname = bankcustomname;
    }
